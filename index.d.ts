...
export { BinaryOperation, ConditionalExpression, Expression, ExpressionConstructor, FieldReference, LiteralValue, FormularInterpreter, FormularParser, AstNode, FormularTokeniser, ConditionResult, isValidExpression };
...
export class FormularInterpreter {
        /**
            ...
            */
        execute<T extends VariableContainer>(astTree: Node, data: T): number | string | any[];
        /**
            ...
            */
        interprete<T extends VariableContainer>(astTree: Node, data: T): Expression<T, string | number | any[]>;
}
export {};
...
export class FormularParser {
        ...
        /**
            ...
            */
        isValidFormular(tokens: (string | number)[]): boolean;
}
export {};
...
}>(expression: string, obj: T): number | string | any[];

export const REGEX: {
    formularOperatorG: RegExp;
    formularOperator: RegExp;
    formularFieldName: RegExp;
};
